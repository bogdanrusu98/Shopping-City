    ...
    <div class="row justify-content-end">
        ...
        <div class="col-md-2 fw-bold text-end">
            <?=$total_amount .' lei'?>
                ...
                <?php
                  if($status == 'New') {
                    echo "<form action='../php/cancelOrder.php?order_id=$order_id' method='post'><button onclick='cancelOrder($order_id)' class='mt-3 btn btn-outline-danger float-end'>Anuleaza comanda</button></form>";
                  }
                ?>
</div>
