...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $insert_query = "INSERT INTO addresses (user_id, user_name, telefon, county, city, address) 
                     VALUES ('$id', '$name', '$phone', '$county', '$city', '$address')";

  // Execută interogarea și verifică rezultatul
  if (mysqli_query($conn, $insert_query)) {
    // Afișează mesajul de succes sau redirecționează către o altă pagină
    $error_message = "<span class='alert alert-success'>Adresa adaugata!</span>";
  ...
  <div class="container my-account my-4">
    ...
    <div class="sidebar rounded">
      <ul class="p-2">
        ...
        <a href="addresses.php">
          <li class="p-1 selected"><i class="fa-solid fa-location-dot"></i> Adrese de livrare</li>
        </a>
    ...
    <div class="content rounded">
      <div class="row container">
        <div class="col-md-12">
          <h4>Adresele mele</h4>
          <button class="btn btn-primary my-4" onclick="showModal()">Adaugă o noua adresa de livrare</button>
          <br>
          <?= $error_message ?>
        </div>
      </div>
      ...
      <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="user-info card-title fw-bold">
                    <i class="fa-solid fa-location-dot mx-2" style="color:#abd373; font-size: 20px;"></i>
                    <span><?php echo $row['user_name'] . ' - ' . $row['telefon']; ?></span>
                  </div>
                  <p class="card-text text-muted"><?php echo $row['address'], ', ', $row['city'], ', ', $row['county']; ?></p>
        ...
        <?php
          ...
          echo "<p>Nu există adrese adaugate.</p>";
        }
        $conn->close();
        ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Adaugă o noua adresa de livrare</h5>
        ...
        <div class="modal-body">
          ...
          <form method="post" id="myForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="row mb-3">
              <h6 class="fw-bold my-2">Persoana de contact</h6>
              <div class="col-md-6">
                <label for="judet" class="form-label">Nume</label>
                <input type="text" class="form-control" id="name" name="name" required>
                <span class="help-block text-danger" style="display: none;">Acest câmp este necesar</span>
              </div>
              <div class="col-md-6">
                <label for="localitate" class="form-label">Numar de telefon</label>
            ...
            <div class="row mb-3">
              <h6 class="fw-bold my-2">Adresa de livrare</h6>
              <div class="col-md-6">
