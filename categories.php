...
// Interogare SQL pentru a selecta toate categoriile distincte din tabelul products
...
<body>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
          ...
          <div class="offcanvas-body text-white">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link active rounded px-3" aria-current="page" href="categories.php">Products</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container">
      <nav aria-label="breadcrumb align-middle ">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item align-middle active" aria-current="page">Categories</li>
  ...
  <!--Contact -->
  <h3 class="text-center">Categorii principale</h3>
  <div class="container my-4">
    <div class="row">
      <?php
      // Verificare dacă există categorii
      if ($result->num_rows > 0) {
        // Afisare categorii în carduri
        while ($row = $result->fetch_assoc()) {
      ?>

          <!-- Afișează fiecare categorie într-un card-->
          <div class="col-md-3 mt-2">
            <div class="card">
              <a href="search_results.php?search_query=<?php echo $row['category'] ?>">
                <img src="<?php echo 'img/categories/' . strtolower($row['category']) . '.jpg'; ?>" class="card-img-top" alt="...">
              </a>
              <div class="card-body">
                <a href="search_results.php?search_query=<?php echo $row['category'] ?>">
