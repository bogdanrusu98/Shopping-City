        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
          ...
          <div class="offcanvas-body text-white">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link active rounded px-3" aria-current="page" href="contact.php">Contact</a>
              </li>
            </ul>
    ...
    <div class="container">
      <nav aria-label="breadcrumb align-middle ">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item align-middle active" aria-current="page">Contact</li>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <form>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" placeholder="Enter your subject" required>
          </div>
          <div class="mb-3">
      ...
      <div class="col-md-6">
        <div class="contact-info p-4">
          ...
          <p>Bine ați venit la ABC Corporation! Suntem aici pentru a vă ajuta să vă răspundem la întrebări, să vă oferim asistență și să ascultăm feedback-ul dvs. Nu ezitați să ne contactați pentru orice nelămurire sau solicitare. Suntem disponibili să vă ajutăm în orice fel putem.
            <br>
            Pentru întrebări, solicitări sau informații suplimentare, vă rugăm să completați formularul de mai jos sau să ne contactați direct la adresa de email info@example.com sau la numărul de telefon +1234567890.
            <br>
            Vă mulțumim că ați ales ABC Corporation!
          </p>
          <h2><i class="fa-solid fa-building"></i> Company Name</h2>
          <p>Shopping City</p>
          <h2><i class="fa-solid fa-location-dot"></i> Address</h2>
          <p>Street Random, number 1</p>
