...
<body>
  ...
  <h3 class="text-center">Politica de confidentialitate</h3>

  <div class="container mb-5">

    <p>
      Ne angajăm să protejăm confidențialitatea informațiilor dvs. personale. Această politică de confidențialitate descrie modul în care colectăm, folosim și protejăm informațiile pe care le puteți furniza pe site-ul nostru.
    </p>
    <h2>Colectarea și Utilizarea Informațiilor</h2>
    <p>
      Colectăm anumite informații personale atunci când ne contactați sau când completați formularele de pe site-ul nostru. Aceste informații pot include numele dvs., adresa de e-mail și alte detalii pe care le furnizați.
    </p>
    <h2>Confidențialitatea Datelor</h2>
    <p>
      Nu vom partaja informațiile dvs. personale cu terțe părți fără consimțământul dvs., cu excepția cazurilor în care suntem obligați să o facem prin lege.
    </p>
    <h2>Securitatea Informațiilor</h2>
    <p>
      Ne angajăm să păstrăm informațiile dvs. personale în siguranță și să protejăm împotriva accesului neautorizat.
    </p>
    <h2>Modificări ale Politicii de Confidențialitate</h2>
    <p>
      Ne rezervăm dreptul de a actualiza sau modifica periodic această politică de confidențialitate. Orice modificări vor fi afișate pe această pagină.
    </p>
