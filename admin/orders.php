...
<body>
    ...
    <button class="w-100 btn btn-primary my-4" data-bs-toggle="modal" data-bs-target="#addItem">Creeaza o comanda</button> <?= $message ?>
  ...
  <!-- Modal pentru adaugarea de produse -->
  <div class="modal fade" id="editOrders" tabindex="-1" aria-labelledby="stockModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="stockModalLabel">Adaugare produs<?=$order_id?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" id="myForm1">
        ...
        <script>
            function searchName() {
                var tableName = "orders"; // înlocuiește "numele_tabelului" cu numele real al tabelului
                var column = "order_id";
